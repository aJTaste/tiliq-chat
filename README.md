...
低スペック端末（学校PC等）でも快適に動くことを目指し、広告なし・外部連携なしで開発しています。名前の由来はお気に入りの動物「アオジタトカゲ」の学名 *Tiliqua*、そして並び替えると "Qualiti"（quality）になることから。
...
| 1 | Supabase設定・DBスキーマ・RLS | 未着手 |
| 2 | 認証フロー | 未着手 |
| 3 | チャットのコア機能（Realtime） | 未着手 |
